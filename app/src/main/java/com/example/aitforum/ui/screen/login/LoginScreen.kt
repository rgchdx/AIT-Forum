...
fun LoginScreen(modifier: Modifier = Modifier,
    ...
    var email by rememberSaveable { mutableStateOf("rgchdx@gmail.com") }
        ...
        Column(
            ...
            Row(
                ...
                OutlinedButton(onClick = {
                    //will need to handle the navigation here
                    //Launch with coroutine so that it will not block the code
